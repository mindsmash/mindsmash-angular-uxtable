(function(angular) {
    ...
    .directive('uxTablePagination', ['$rootScope', '$timeout', function($rootScope, $timeout) {
        return {
            replace: true,
            restrict: 'AE',
    ...
    .directive('uxTablePaginationSize', ['$rootScope', '$compile', '$filter', function($rootScope, $compile, $filter) {
        return {
            replace: true,
            restrict: 'AE',
    ...
    .directive('uxTableToggle', ['$rootScope', '$compile', function($rootScope, $compile) {
        return {
            replace: true,
            restrict: 'AE',
    ...
    .directive('uxTableCounter', ['$rootScope', '$compile', function($rootScope, $compile) {
        return {
            replace: true,
            restrict: 'AE',
    ...
    .directive('uxTableSelectionCounter', ['$rootScope', '$compile', function($rootScope, $compile) {
        return {
            replace: true,
            restrict: 'AE',
    ...
    .directive('uxTableFacets', ['$rootScope', function($rootScope) {
        return {
            replace: true,
            restrict: 'AE',
    ...
    .factory('ElementClickListener', ['$window', '$timeout', function($window, $timeout) {
        var listeners = {};
